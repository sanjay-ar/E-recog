...
export declare type SpeakerVoiceEmotion = LazyLoading extends LazyLoadingDisabled ? EagerSpeakerVoiceEmotion : LazySpeakerVoiceEmotion

export declare const SpeakerVoiceEmotion: (new (init: ModelInit<SpeakerVoiceEmotion>) => SpeakerVoiceEmotion) & {
  copyOf(source: SpeakerVoiceEmotion, mutator: (draft: MutableModel<SpeakerVoiceEmotion>) => MutableModel<SpeakerVoiceEmotion> | void): SpeakerVoiceEmotion;
}
...
export declare type PublicMeetingInfo = LazyLoading extends LazyLoadingDisabled ? EagerPublicMeetingInfo : LazyPublicMeetingInfo

export declare const PublicMeetingInfo: (new (init: ModelInit<PublicMeetingInfo>) => PublicMeetingInfo) & {
  copyOf(source: PublicMeetingInfo, mutator: (draft: MutableModel<PublicMeetingInfo>) => MutableModel<PublicMeetingInfo> | void): PublicMeetingInfo;
}
...
export declare type AudienceFaceExpression = LazyLoading extends LazyLoadingDisabled ? EagerAudienceFaceExpression : LazyAudienceFaceExpression

export declare const AudienceFaceExpression: (new (init: ModelInit<AudienceFaceExpression>) => AudienceFaceExpression) & {
  copyOf(source: AudienceFaceExpression, mutator: (draft: MutableModel<AudienceFaceExpression>) => MutableModel<AudienceFaceExpression> | void): AudienceFaceExpression;
}